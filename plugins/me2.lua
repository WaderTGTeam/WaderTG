...
local text = 'فعالین امروز گروه\n'..maxname[1]..' '..maxuser[1]..'\n\nتعداد پیام های ارسال شده: '..maxtex[1] + maxph[1] + maxst[1] + maxoth[1]..'\n\nتعداد استیکر: '..maxst[1]..'\n\nتعداد عکس: '..maxph[1]..'\n\nتعداد متن: '..maxtex[1]..'\n\nدیگر: '..maxoth[1]
if maxid[2] then
	if not maxid[3] then
text = text..'\n\n'..maxname[2]..' '..maxuser[2]..'\n\nتعداد پیام های ارسال شده: '..maxtex[2] + maxph[2] + maxst[2] + maxoth[2]..'\n\nتعداد استیکر: '..maxst[2]..'\n\nتعداد عکس: '..maxph[2]..'\n\nتعداد متن: '..maxtex[2]..'\n\nدیگر: '..maxoth[2]
else
text = text..'\n\n'..maxname[2]..' '..maxuser[2]..'\n\nتعداد پیام های ارسال شده: '..maxtex[2] + maxph[2] + maxst[2] + maxoth[2]..'\n\nتعداد استیکر: '..maxst[2]..'\n\nتعداد عکس: '..maxph[2]..'\n\nتعداد متن: '..maxtex[2]..'\n\nدیگر: '..maxoth[2]..'\n\n '..maxname[3]..' '..maxuser[3]..'\n\nتعداد پیام های ارسال شده: '..maxtex[3] + maxph[3] + maxst[3] + maxoth[3]..'\n\nتعداد استیکر: '..maxst[3]..'\n\nتعداد عکس: '..maxph[3]..'\n\nتعداد متن: '..maxtex[3]..'\n\nدیگر: '..maxoth[3]
end
end
