...
if matches[1] == 'حذف پیام خوش امدگویی' and not matches[2] and is_owner(msg) then 
...
if matches[1] == 'تنظیم پیام خوش امدگویی' and is_owner(msg) then
...
return {
  patterns = {
  "^(تنظیم پیام خوش امدگویی) +(.*)$",
  "^(حذف پیام خوش امدگویی)$",
