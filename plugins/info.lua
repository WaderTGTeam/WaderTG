local sudo = 293066613 --put your id here(BOT OWNER ID)
...
local function run(msg, matches)
 if matches[1]:lower() == 'تنظیم اطلاعات' then
 ...
 if matches[1]:lower() == 'اطلاعات من' and not matches[2] then
  local receiver = get_receiver(msg)
  local Reply = msg.reply_id
  if msg.reply_id then
  ...
  if matches[1]:lower() == 'اطلاعات من' and matches[2] then
